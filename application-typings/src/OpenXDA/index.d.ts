...
// Lists
//export const AssetTypes: OpenXDA.AssetTypeName[] = ['Line', 'LineSegment', 'Breaker' , 'Bus' , 'CapacitorBank' , 'Transformer' , 'CapacitorBankRelay']
//export const MeasurementTypes: OpenXDA.MeasurementTypeName[] = ['Voltage' , 'Current' , 'Power' , 'Energy' , 'Digital'];
//export const MeasurementCharacteristics: OpenXDA.MeasurementCharacteristicName[] = ['AngleFund' , 'AvgImbal' , 'CrestFactor' , 'FlkrPLT' , 'FlkrPST' , 'Frequency' , 'HRMS' , 'IHRMS' , 'Instantaneous' , 'IT' , 'None' , 'P' , 'PDemand' , 'PF' , 'PFDemand' , 'PIntg' , 'PPeakDemand' , 'QDemand' , 'QFund' , 'QIntg' , 'RMS' , 'RMSPeakDemand' , 'S' , 'SDemand' , 'SNeg' , 'SpectraHGroup' , 'SPos' , 'SZero' , 'TDD' , 'TID' , 'TIDRMS' , 'TotalTHD' , 'TotalTHDRMS' , 'BreakerStatus' , 'TCE' , 'Q' , 'PIVLIntgPos' , 'QIVLIntgPos' , 'Peak' , 'FlkrMagAvg' , 'EvenTHD' , 'OddTHD' , 'FormFactor' , 'ArithSum' , 'S0S1' , 'S2S1' , 'TIF' , 'DF' , 'SIntgFund' , 'DFArith' , 'DFVector' , 'PFArith' , 'PFVector' , 'PHarmonic' , 'SArith' , 'SArithFund' , 'SVector' , 'SVectorFund' , 'Spectra' , 'SpectraIGroup'];
//export const Phases: OpenXDA.PhaseName[] = ['AN' , 'BN' , 'CN' , 'AB' , 'BC' , 'CA' , 'RES' , 'NG' , 'None' , 'Worst' , 'LineToNeutralAverage' , 'LineToLineAverage'];
//export const EventTypes: OpenXDA.EventTypeName[] = ['Sag' , 'Swell' , 'Transient' , 'Fault' , 'Interruption']
//export const NoteTypes = ['Meter' , 'Event' , 'Asset' , 'Location' , 'Customer' , 'User' , 'Company'] as OpenXDA.NoteTypeName[];
...
declare module "OpenXDA" {
    namespace OpenXDA
    {
        ...
        export interface CapBankRelay extends Asset { OnVoltageThreshhold: number }
        export interface Line extends Asset { MaxFaultDistance: number, MinFaultDistance: number, Detail: LineDetail }
        export interface LineSegment extends Asset { R0: number, X0: number, R1: number, X1: number, ThermalRating: number, Length: number }
        export interface Transformer extends Asset { R0: number, X0: number, R1: number, X1: number, ThermalRating: number, PrimaryVoltageKV: number, SecondaryVoltageKV: number, Tap: number }
