...
namespace PqDiff{
    export namespace Types {
        ...
        export type Phase = 'AN' | 'BN' | 'CN' | 'AB' | 'BC' | 'CA' | 'RES' | 'NG' | 'None' | 'Worst' | 'LineToNeutralAverage' | 'LineToLineAverage';
    }
    export namespace Lists{
        ...
        export const Phases: Types.Phase[] = ['AN', 'BN', 'CN', 'AB', 'BC', 'CA', 'RES', 'NG', 'None', 'Worst', 'LineToNeutralAverage', 'LineToLineAverage'];
    }
}
